...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.checkbox_10 = wx.CheckBox(self.notebook_1_pane_7, 8, "packets received")
        self.checkbox_17 = wx.CheckBox(self.notebook_1_pane_7, 9, "bytes received")
        self.checkbox_21 = wx.CheckBox(self.notebook_1_pane_7, 10, "packets transmitted")
        self.checkbox_22 = wx.CheckBox(self.notebook_1_pane_7, 11, "bytes transmitted")
        self.notebook_1_pane_8 = wx.Panel(self.notebook_1, -1)
        self.checkbox_10_copy = wx.CheckBox(self.notebook_1_pane_8, 8, "packets received")
        self.checkbox_17_copy = wx.CheckBox(self.notebook_1_pane_8, 9, "bytes received")
        self.checkbox_21_copy = wx.CheckBox(self.notebook_1_pane_8, 10, "packets transmitted")
        self.checkbox_22_copy = wx.CheckBox(self.notebook_1_pane_8, 11, "bytes transmitted")
        self.notebook_1_pane_9 = wx.Panel(self.notebook_1, -1)
        self.checkbox_10_copy_1 = wx.CheckBox(self.notebook_1_pane_9, 8, "packets received")
        self.checkbox_17_copy_1 = wx.CheckBox(self.notebook_1_pane_9, 9, "bytes received")
        self.checkbox_21_copy_1 = wx.CheckBox(self.notebook_1_pane_9, 10, "packets transmitted")
        self.checkbox_22_copy_1 = wx.CheckBox(self.notebook_1_pane_9, 11, "bytes transmitted")
        self.notebook_1_pane_10 = wx.Panel(self.notebook_1, -1)
        self.checkbox_10_copy_2 = wx.CheckBox(self.notebook_1_pane_10, 8, "packets received")
        self.checkbox_17_copy_2 = wx.CheckBox(self.notebook_1_pane_10, 9, "bytes received")
        self.checkbox_21_copy_2 = wx.CheckBox(self.notebook_1_pane_10, 10, "packets transmitted")
        self.checkbox_22_copy_2 = wx.CheckBox(self.notebook_1_pane_10, 11, "bytes transmitted")
    ...
    def load_fileA(self, event):  # wxGlade: MyFrame.<event_handler>
        print "Event handler `load_fileA' not implemented!"
        event.Skip()

    def load_fileB(self, event):  # wxGlade: MyFrame.<event_handler>
        print "Event handler `load_fileB' not implemented!"
        event.Skip()
